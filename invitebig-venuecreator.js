...
function CreateMenu(e, t) {
    var n = "<div class='creatorcategory menu formpan'><p style='float:left;margin:auto'>" + e + "			</p><small class='editBar'>				<a name='buttonEdit' href='#' style='margin-left:10px'>Edit</a> | 				<a name='buttonDelete' href='#'>Delete</a>			<button name='buttonAddMenuItem' class='btn btn-xs btn-primary pull-right' style='margin:auto auto auto 10px'>+ Item</button></small>			<div class='clearfix'></div>			</div>";
