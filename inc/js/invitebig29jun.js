...
function responsiveView() {
    if (resizeQueue.length > 1) {
        ...
        if(sessionStorage.getItem("displayHeader") == "true")
        {
                 $("#bookHeaders").show();
                 //$("#temptext").show();
                 //$("#temptext").hide();
        ...
        {
            if (window.location.href.indexOf("/reserve/book-an-event-at-") > 0)
            {
                //alert("2");
                //$("#bookHeaders").show();    
                var str = window.location.href;
                str = str.substring(window.location.href.indexOf("&")+1);
                if(str=="displayHeader=false") 
                {
                  //  alert("3");
                     $("#bookHeaders").hide();    
                     //$("#temptext").show();
        ...
        // {
        //     //alert("true");
        //     // $("div.bookHeading").css("display","block !important");
        //     // $("div.bookHeader").css("display","block !important");
        ...
        // else
        // {
        //     // $("div.bookHeading").css("display","none !important");
        //     // $("div.bookHeader").css("display","none !important");
        //     //alert(window.location.href.indexOf("/reserve/book-an-event-at-"));
        //     //if (window.location.href.indexOf("/reserve/book-an-event-at-") > 0)
        //     //alert(window.location.href);
        //     //console.log("Path:-",window.location.href);
        //     //if(window.location.href=="https://d.invitebig.com/dashboard#integrations")
        //     if (window.location.href.indexOf("/reserve/book-an-event-at-") > 0)
        //     {
