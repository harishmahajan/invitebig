...
if ($client->isAccessTokenExpired()) {
	$sqlSelect = "SELECT * FROM googleCallist where status = 1 and refresh_token!=''";
...
//echo "<br>***********<br>";
				// To sync with google calender
				//$sqlBooking = "SELECT * FROM booking where start > '".strtotime(date("Y/m/d"))."'";
...
//echo "<br>***********<br>";
				...
				//print_r($events);
				//Calendar Events insert/update to DB	
				while(true) {
						foreach ($events->getItems() as $event) {				
							//echo $userid."=>".$event->getSummary()."<br>";	
							...
							else
							{
								...
								//{
									...
									//echo "\r\nEventid = ".$eventid."=>".$event->creator->email;
									echo "<br>Inserted :- ".$venueid;
									echo "<br>";
									$status = "Imported";
									$flag=1;
